  ...
  return (
    <>
            ...
            <div className="mt-8 grid gap-6 lg:grid-cols-[0.9fr_1.1fr]">
              <SectionReveal className="rounded-lg border border-slate-100 bg-white p-5 shadow-lift">
                ...
                <div className="mt-6 flex flex-col gap-3 sm:flex-row">
                  ...
                  <a href={school.whatsapp} className="inline-flex h-12 items-center justify-center gap-2 rounded-lg bg-teal px-5 text-sm font-extrabold text-white shadow-soft transition hover:-translate-y-0.5">
      ...
      <a
        ...
        className="fixed bottom-5 right-24 z-50 hidden h-14 items-center justify-center gap-2 rounded-full bg-[#128C7E] px-5 text-sm font-extrabold text-white shadow-lift transition hover:scale-105 md:flex"
      ...
      <div className="fixed inset-x-0 bottom-0 z-50 grid grid-cols-2 gap-2 border-t border-white/20 bg-white/96 p-3 shadow-lift backdrop-blur md:hidden">
        ...
        <a href={school.whatsapp} className="inline-flex h-12 items-center justify-center gap-2 rounded-lg bg-[#128C7E] text-sm font-extrabold text-white">
          <MessageCircle size={18} aria-hidden="true" />
          WhatsApp
        </a>
      </div>
